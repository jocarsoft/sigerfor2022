                            ...
                            <fieldset>
                                <div class="form-card">
                                    <div class="row">
                                        ...
                                        <?= $form->field($model, 'FECONT')->widget(\yii\jui\DatePicker::className(), [
                            ...
                            <fieldset>
                                <div class="form-card">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <?= $form->field($model, 'FECMOD')->widget(\yii\jui\DatePicker::className(), [
                                                    // si estás usando bootstrap, la siguiente linea asignará correctamente el estilo del campo de entrada
                                                    'options' => ['class' => 'form-control'],  
                                                    'language' => 'es',
                                                    //'format' => 'yyyy-mm-dd hh:ii',
                                        ...
                                        <div class="col-md-6">
                                            <?= $form->field($model, 'FECCON')->widget(\yii\jui\DatePicker::className(), [
                                                    // si estás usando bootstrap, la siguiente linea asignará correctamente el estilo del campo de entrada
                                                    'options' => ['class' => 'form-control'],  
                                                    'language' => 'es',
                                                    //'format' => 'yyyy-mm-dd hh:ii',
                                        ...
                                        <div class="col-md-6"> 
                                            <?= $form->field($model, 'FECOSI')->widget(\yii\jui\DatePicker::className(), [
                                                    // si estás usando bootstrap, la siguiente linea asignará correctamente el estilo del campo de entrada
                                                    'options' => ['class' => 'form-control'],  
                                                    'language' => 'es',
                                                    //'format' => 'yyyy-mm-dd hh:ii',
